...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(template_name='Auth/login.html',authentication_form=LoginForm, extra_context=({'title':'Login','Tab':'login'})), name = 'auth_login'),
    ...
    path('passwordChangeDone/', auth_views.PasswordChangeDoneView.as_view(template_name='Auth/passwordChangeDone.html',extra_context=({'title':'Password Changed !','Tab':'profile'})), name = 'auth_password_change_done'),
